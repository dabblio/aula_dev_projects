...
// ----------------------------------------------------------------
// Alternar mostrar/ocultar senha (botão customizado)
...
// Animar emojis de aceno quando qualquer botão .btn-grad for clicado
const waveEmojis = document.querySelectorAll('.wave-emoji');
document.querySelectorAll('.btn-grad').forEach(button => {
  button.addEventListener('click', () => {
    waveEmojis.forEach(emoji => {
      // reinicia a animação caso esteja rodando
      emoji.classList.remove('waving');
      // força reflow para reiniciar a animação
      void emoji.offsetWidth;
      emoji.classList.add('waving');
      // remover a classe após a animação (tempo do keyframes + margem)
